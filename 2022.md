...
The primary activity of the working group is the organization of the annual International Conference on Trust Management (IFIPTM). 
The working group also aims to organize and/or sponsor cross-disciplinary workshops and meetings on trust in a digital society, explicit trust management, trust technologies and other trust related topics.
Finally the working group aims to facilitate contact among researchers and practitioners in the area of digital trust and trust management, with respect to develop joint research proposals.
...
The working group maintains a website www.ifiptm.org, which includes different ways to contact the working group.
